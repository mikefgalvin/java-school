...
public class RestExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    public RestExceptionHandler() { super(); } //not needed but can make changes if needed
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers, HttpStatus status, WebRequest request)
    {
        ...
        errorDetail.setDetail("What are you trying to do here???: " + ex.getMessage());
            ...
            WebRequest request)
    {
        ...
        errorDetail.setDetail("Endpoint doesn't exist....sorry: " + request.getDescription(false));
